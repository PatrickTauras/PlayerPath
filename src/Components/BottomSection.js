...
const BottomSection = () => (
  <div className={styles.bottomSection}>
    ...
    <div className={styles.linksContainer}>
      <a href={`${process.env.PUBLIC_URL}/privacy-policy`} className={styles.link}>Privacy Policy</a>
      <a href={`${process.env.PUBLIC_URL}/contact`} className={styles.link}>Contact</a>
    </div>
